...
public class RemoveArmorEnhancement extends CustomRecipe {
    ...
    public static final SimpleRecipeSerializer<RemoveArmorEnhancement> REMOVE_ARMOR_ENHANCEMENT_SERIALIZER = new SimpleRecipeSerializer<>(RemoveArmorEnhancement::new);

    public static void init() {
        REMOVE_ARMOR_ENHANCEMENT_SERIALIZER.setRegistryName(new ResourceLocation(Homeostatic.MODID, "remove_armor_enhancement"));
    }
    ...
    public RecipeSerializer<?> getSerializer() {
        return REMOVE_ARMOR_ENHANCEMENT_SERIALIZER;
    }
