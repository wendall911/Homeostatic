...
public class BiomeCategoryProvider implements DataProvider {
    ...
    protected void registerBiomeCategories() {
        ...
        add(ModIntegration.bygLoc("windswept_beach"), BiomeCategory.Type.BEACH);
    ...
    public void run(HashCache pCache) throws IOException {
        ...
        for (Map.Entry<ResourceLocation, BiomeCategory> entry : BIOME_CATEGORY_MAP.entrySet()) {
            ...
            try {
                DataProvider.save(GSON, pCache, BiomeCategoryManager.parseBiomeCategory(entry.getValue()), biomeCategoryPath);
            }
            catch (IOException e) {
