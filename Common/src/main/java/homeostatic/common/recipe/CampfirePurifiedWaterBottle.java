...
public class CampfirePurifiedWaterBottle extends CampfireCookingRecipe implements IWaterBottleCookingRecipe {
    ...
    public CampfirePurifiedWaterBottle(ResourceLocation id, String group, CookingBookCategory category, Ingredient ingredient, ItemStack result, float experience, int cookingTime) {
