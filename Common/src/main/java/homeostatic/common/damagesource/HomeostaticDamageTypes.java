...
public class HomeostaticDamageTypes {
    ...
    public static final ResourceKey<DamageType> HYPERTHERMIA_KEY = ResourceKey.create(Registries.DAMAGE_TYPE, prefix("hyperthermia"));
    private static final DamageType HYPERTHERMIA = new DamageType("hasHyperthermia", 0.0F);
    public static final ResourceKey<DamageType> SCALDING_KEY = ResourceKey.create(Registries.DAMAGE_TYPE, prefix("scalding"));
    private static final DamageType SCALDING = new DamageType("isScalding", 0.0F);
    public static final ResourceKey<DamageType> DEHYDRATION_KEY = ResourceKey.create(Registries.DAMAGE_TYPE, prefix("dehydration"));
