...
public class DrinkableItemsProvider implements DataProvider {
    ...
    protected void addDrinkableItems() {
        ...
        // More Food xD Fabric
        addMeal(ModIntegration.mffLoc("apple_bread"));
        addPie(ModIntegration.mffLoc("apple_pie"));
        addSoup(ModIntegration.mffLoc("apple_soup"));
        addSoup(ModIntegration.mffLoc("bamboo_soup"));
        addMeal(ModIntegration.mffLoc("carrot_bread"));
        addPie(ModIntegration.mffLoc("carrot_pie"));
        addSoup(ModIntegration.mffLoc("carrot_soup"));
        addMeal(ModIntegration.mffLoc("chocolate"));
        addMeal(ModIntegration.mffLoc("chocolate_bar"));
        addFruit(ModIntegration.mffLoc("cooked_apple"));
        add(ModIntegration.mffLoc("diamond_apple"), 6, 1.2F,  0, 0, 0.0F);
        addVeggie(ModIntegration.mffLoc("diamond_carrot"));
        addVeggie(ModIntegration.mffLoc("diamond_kelp"));
        addFruit(ModIntegration.mffLoc("diamond_melon_slice"));
        addVeggie(ModIntegration.mffLoc("diamond_potato"));
        addVeggie(ModIntegration.mffLoc("emerald_carrot"));
        addVeggie(ModIntegration.mffLoc("emerald_kelp"));
        addFruit(ModIntegration.mffLoc("emerald_melon_slice"));
        addVeggie(ModIntegration.mffLoc("emerald_potato"));
        addVeggie(ModIntegration.mffLoc("golden_kelp"));
        addFruit(ModIntegration.mffLoc("golden_melon_slice"));
        addVeggie(ModIntegration.mffLoc("golden_potato"));
        addVeggie(ModIntegration.mffLoc("iron_carrot"));
        addVeggie(ModIntegration.mffLoc("iron_kelp"));
        addFruit(ModIntegration.mffLoc("iron_melon_slice"));
        addVeggie(ModIntegration.mffLoc("iron_potato"));
        addSoup(ModIntegration.mffLoc("kelp_soup"));
        addSoup(ModIntegration.mffLoc("phantom_soup"));
        addMeal(ModIntegration.mffLoc("potato_bread"));
        addSoup(ModIntegration.mffLoc("potato_soup"));
        addSoup(ModIntegration.mffLoc("pufferfish_soup"));
        addSoup(ModIntegration.mffLoc("pumpking_soup"));
        addMeal(ModIntegration.mffLoc("rice_chicken_bowl"));
        addMeal(ModIntegration.mffLoc("rice_cod_bowl"));
        addMeal(ModIntegration.mffLoc("rice_honey_pudding"));
        addMeal(ModIntegration.mffLoc("rice_salmon_bowl"));
        addMeal(ModIntegration.mffLoc("rice_vegetable_bowl"));
        addMeal(ModIntegration.mffLoc("sushi_bamboo"));
        addMeal(ModIntegration.mffLoc("sushi_beetroot"));
        addMeal(ModIntegration.mffLoc("sushi_carrot"));
        addMeal(ModIntegration.mffLoc("sushi_salmon"));
